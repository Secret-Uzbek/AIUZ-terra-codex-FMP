...
* **РR&D центраальная передача знаний** - мистерии инициации для закрепления важных навыков
...
qariya.paleolithic.wisdom.restore() {
    ...
    современные_рR&D центраалы: церемонии_перехода_в_новые_возрастные_группы
}
```
...
* **Устная Традиция** - знания передаются через истории и рR&D центраалы
