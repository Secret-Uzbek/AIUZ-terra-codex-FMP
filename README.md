...
- [FMP.md](./FMP.md)
- [Article 1 - Fractal Metascience Foundation (eng).pdf](./Article%201%20%E2%80%93%20Fractal%20Metascience%20Foundation%20(eng).pdf)
- [Fractal Metascience_ New Academic Discipline Proposal.pdf](./Fractal%20Metascience_%20New%20Academic%20Discipline%20Proposal.pdf)
- `Theory/`

### Practice

- documentation and release workflows in `.github/`
- living index files and publication preparation artifacts
- translational, operational, and dissemination support files
- `Agents/`, `Core/`, `Publications/`

## Governance and Standards

This repository inherits its donor governance from `terra-legal`.

Read first:

- [Terra Legal README](https://github.com/AIUZ-Terra-Codex-EcoSystem/terra-legal)
...
1. Read `FMP.md`
2. Open the English article PDF
3. Review `DOCUMENTATION-STANDARD.md`

### If you want publication context

1. Read `FMP.md`
2. Review `CITATION.cff`
3. Check release and publication workflows in `.github/workflows/`

### If you want repository rules
...
This repository should not be used as a dump for every Terra artifact.
...
- unrelated raw session debris;
- duplicate living indexes;
- broken encoding residues;
- files that belong to other Terra branches.

## Citation

If you use this repository as a source, use the metadata in `CITATION.cff` and
the repository DOI shown above.
